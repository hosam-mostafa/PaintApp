...
public class MyPanel extends JPanel {
   ...
   //constructor
        ...
        if(colorChosen!=null && shapeChosen!=null){
            ...
            if(!dot){
                switch(shapesall){
                    ...
                    drawDashedShapes(g, x, y, x2, y2,shapesall);
                }
        }
    }
    //paint
    ...
    //draw dashed shapes
    public void drawDashedShapes(Graphics g, int x1, int y1, int x2, int y2, String shapesall){
    ...
    //inner class to identify the vector of all shapes
    public class Plot
    {   
        private String type;
